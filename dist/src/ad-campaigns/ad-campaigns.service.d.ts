...
export declare class AdCampaignsService {
    ...
    createIntegration(tenantId: string, createDto: CreateIntegrationDto): Promise<{
        id: string;
        name: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    getIntegration(tenantId: string, integrationId: string): Promise<{
        id: string;
        name: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    updateIntegration(tenantId: string, integrationId: string, updateDto: UpdateIntegrationDto): Promise<{
        id: string;
        name: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    deleteIntegration(tenantId: string, integrationId: string): Promise<{
        id: string;
        name: string;
        createdAt: Date;
        updatedAt: Date;
