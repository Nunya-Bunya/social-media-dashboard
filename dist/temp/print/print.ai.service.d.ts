...
export declare class PrintAiService {
    private readonly prisma;
    private readonly aiProvider;
    constructor(prisma: PrismaService, aiProvider: AiProvider);
    generateContent(projectId: string, prompt: string, context: any, tenantId: string): Promise<{
        content: string;
        projectId: string;
        generatedAt: Date;
    }>;
    optimizeContent(projectId: string, content: string, tenantId: string): Promise<{
