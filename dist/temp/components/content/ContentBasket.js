...
exports.ContentBasket = ContentBasket;
...
function ContentBasket() {
    ...
    const categories = [
        { id: 'all', name: 'All Categories', icon: lucide_react_1.FileText },
        { id: 'educational', name: 'Educational', icon: lucide_react_1.BookOpen },
        { id: 'engagement', name: 'Engagement', icon: lucide_react_1.Users },
        { id: 'branding', name: 'Branding', icon: lucide_react_1.Palette },
        { id: 'news', name: 'News & Updates', icon: lucide_react_1.AlertTriangle },
        { id: 'client-stories', name: 'Client Stories', icon: lucide_react_1.Star }
    ];
    ...
    const handleAiGenerate = async () => {
        if (!selectedTemplate || !aiInput.trim())
            return;
    ...
    return (<div className="space-y-6">
      ...
      <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <tabs_1.TabsList>
          <tabs_1.TabsTrigger value="templates">Content Templates</tabs_1.TabsTrigger>
          <tabs_1.TabsTrigger value="create">Create Content</tabs_1.TabsTrigger>
          <tabs_1.TabsTrigger value="generated">Generated Content</tabs_1.TabsTrigger>
        </tabs_1.TabsList>
        ...
        <tabs_1.TabsContent value="templates" className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1">
              <input_1.Input placeholder="Search content templates..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full"/>
            </div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {filteredTemplates.map((template) => (<card_1.Card key={template.id} className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => handleTemplateSelect(template)}>
                <card_1.CardHeader>
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <card_1.CardTitle className="text-lg">{template.title}</card_1.CardTitle>
                ...
                <card_1.CardContent>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <badge_1.Badge variant={template.difficulty === 'easy' ? 'default' :
                template.difficulty === 'medium' ? 'secondary' : 'destructive'}>
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <div className="flex space-x-1">
                        {template.platforms.slice(0, 2).map((platform) => (<badge_1.Badge key={platform} variant="outline" className="text-xs">
                            {platform}
                          </badge_1.Badge>))}
                        {template.platforms.length > 2 && (<badge_1.Badge variant="outline" className="text-xs">
          ...
          {selectedTemplate ? (<card_1.Card>
              ...
              <card_1.CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  <label_1.Label>Template Preview</label_1.Label>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <label_1.Label className="text-lg font-medium">AI Content Generation</label_1.Label>
                  </div>
                  <div className="space-y-2">
                    <label_1.Label htmlFor="ai-input">Describe what you want to create:</label_1.Label>
                    <textarea_1.Textarea id="ai-input" placeholder={`e.g., ${selectedTemplate.aiPrompt}`} value={aiInput} onChange={(e) => setAiInput(e.target.value)} className="min-h-[100px]"/>
                  </div>
                  <button_1.Button onClick={handleAiGenerate} disabled={!aiInput.trim()} className="w-full">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-2">
                    <lucide_react_1.Edit className="h-5 w-5 text-green-600"/>
                    <label_1.Label className="text-lg font-medium">Manual Content Creation</label_1.Label>
                  </div>
                  <div className="space-y-2">
                    <label_1.Label htmlFor="manual-content">Write your content:</label_1.Label>
                    <textarea_1.Textarea id="manual-content" placeholder="Write your content here..." className="min-h-[150px]"/>
                  </div>
        ...
        <tabs_1.TabsContent value="generated" className="space-y-4">
          {generatedContent.length > 0 ? (<div className="space-y-4">
              {generatedContent.map((content) => (<card_1.Card key={content.id}>
                  <card_1.CardContent className="p-4">
                    <div className="flex items-start justify-between">
                      <div className="flex-1 space-y-2">
                        <div className="flex items-center space-x-2">
                          {content.aiGenerated && (<badge_1.Badge variant="outline" className="bg-blue-50 text-blue-700">
                              <lucide_react_1.Sparkles className="w-3 h-3 mr-1"/>
                              AI Generated
                            </badge_1.Badge>)}
                          <badge_1.Badge variant="outline" className="capitalize">
                      ...
                      <div className="flex items-center space-x-2">
                        <button_1.Button variant="ghost" size="sm" onClick={() => copyToClipboard(content.content)}>
              ...
              <lucide_react_1.Sparkles className="mx-auto h-12 w-12 text-gray-400 mb-4"/>
...
//# sourceMappingURL=ContentBasket.js.map